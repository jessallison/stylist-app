...
// is view-open): the wardrobe holds photos of Jess and what she owns, so the
// whole thing is private. Accepts the header (fetch calls) or the httpOnly
// cookie set at login (lets plain <img src="/api/image/..."> work).
