...
export const DEFAULT_SETTINGS = {
  ...
  regulars: [],
  // Home city for today's weather on the Style me tab - { label, city, lat,
  // lon, tz } as resolved by lib/weather.js geocodeCity, or null when not
  // set. Optional: with nothing here the weather line simply doesn't show.
  home: null,
};
...
export const SEASONS = ["All seasons", "Warm weather", "Cold weather"];
...
//
// Five of these (Cream, Tan, Olive, Yellow, Mustard) were darkened again in
// Sep 2026: measured against white, Yellow and Mustard sat at ~3:1 contrast
// and Cream at ~4.2:1 - all below the 4.5:1 floor for small text, which is
// exactly the "washed out" look Jess flagged on a real wardrobe's worth of
// colour filters. This wasn't a dark-mode bug - .filter-panel and a
// light-mode ChipPick card are both white already, so it read the same in
// both themes; dark mode just made the surrounding chrome black, which
// made the weak entries stand out more by contrast. Every entry here now
// clears ~5:1 against white.
